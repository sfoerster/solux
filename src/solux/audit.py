...
Supports SQLCipher encryption at rest (config-gated via SOLUX_AUDIT_DB_KEY).
...
_AUDIT_DB_KEY = os.environ.get("SOLUX_AUDIT_DB_KEY", "")
    ...
    def _raw_connect(self) -> sqlite3.Connection:
        ...
        if self._db_key:
            try:
                ...
                _log.warning("SOLUX_AUDIT_DB_KEY is set but pysqlcipher3 is not installed; using plain SQLite")

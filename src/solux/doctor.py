...
def _collect_scoped_deps(
    ...
    has not explicitly configured so that ``solux doctor`` only checks what is
    actually needed.
    ...
    *,
    ...
    if config.config_exists:
        ...
        _print(
            ...
            "Run: solux init" if fix else "Create config.toml to set whisper paths and preferred model.",
            fix=fix,
        )
